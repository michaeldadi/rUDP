...
def create_rudp_dgram(seq, ack, payload):
    ...
    return struct.pack(b'BBB%ds' % str_len, seq, ack, str_len, payload)
    # Calculate checksum
    # checksum = hashlib.md5(dgram)
    # # Return final RUDP datagram
    # return struct.pack(b'BBBB%ds' % str_len, seq, ack, checksum, str_len, payload)
